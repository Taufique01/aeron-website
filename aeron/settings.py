"""
Django settings for aeron project.
...
SECRET_KEY = '+fi)lfu1_qjx2((%orfs1ydp0!*xvo_lwin^l-qoi5z4ek(-s9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
     'taufique01.pythonanywhere.com',
      '127.0.0.1',
...
WSGI_APPLICATION = 'aeron.wsgi.application'
